...
<body>
	<div class="wrapper">
		<div style="text-align: center; font-family: Lucida Handwriting; font-weight: bold;">
			<hl style="font-size: 20px;"> Student Login </hl> <br>
	...
	<?php
		if(isset($_POST['submit'])){
			$query=mysqli_query($db, "SELECT * FROM `student` WHERE email='$_POST[email]' ");
			if(mysqli_num_rows($query)>0){
				$sth=mysqli_query($db, "UPDATE student set password='$_POST[password]' where email='$_POST[email]';")
				?>
